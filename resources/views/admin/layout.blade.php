            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li >
                    <a href="{{url('admin/sales')}}">
                        <i class="fab fa-drupal text-purple "></i>
                        <span> Sales Drug</span>
                    </a>
                </li>
                ...
                <li >
                    <a href="{{url('admin/expired')}}">
                        <i class="fab fa-drupal text-purple "></i>
                        <span> Expired Drug Inventory</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{url('admin/logout')}}">
                        ...
                        <div class="label label-purple pull-right"></div>
                        <span>Logout</span>
                    </a>
                </li>
                <!-- END Menu-->
