    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
            // Add title
                ...
                ../../http/add custom colors                color_319619358.html['#689f38', '#38649f', '#389f99', '#ee1044', '#ff8f00'],

                ../../http/display toolbox                toolbox_273358622.html{
                    show: true,
                    orient: 'vertical',
                    feature: {
                        mark: {
                ...
                ../../http/enabledragrecalculatecalculabletrue,/Add series                series_1698306853.html[{
                    name: 'Marketing',
                    type: 'pie',
                    radius: '70%',
                    center: ['50%', '57.5%'],
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
           ...
           tooltip: {
                ...
                ../../http/enabledragrecalculatecalculablefalse,/Add series                series_1698306853.html[
                    ...
                    // Inner
                    {
                        ...
                        ../../http/for funnel                        x_1315206757.html '15%',
                        y: '7.5%',
                        width: '40%',
                        height: '85%',
                        funnelAlign: 'right',
                    ...
                    ../../http/outer_386299247.html{
                        name: 'Countries',
                        type: 'pie',
                        radius: ['60%', '85%'],

                        ../../http/for funnel                        x_1315206757.html '55%',
                        y: '7.5%',
                        width: '35%',
                        height: '85%',
                        funnelAlign: 'left',
        ...
        // based on prepared DOM, initialize echarts instance
            ...
            var option = {
                ...
                ../../http/add tooltip                tooltip_1982692711.html{
                    show: true,
                    formatter: "{a} <br/>{b}: {c} ({d}%)"
                },
                ...
                ../../http/add custom colors                color_319619358.html['#689f38', '#38649f', '#ff8f00'],
 
                ../../http/add series                series_1698306821.html[
                    {
                        name: '1',
                        type: 'pie',
                        clockWise: false,
                ...
                ../../http/enabledragrecalculatecalculabletrue,/Add series                series_1698306853.html[
                    {
                        ...
                        ../../http/funnel                        width_124874087.html '40%',
                        height: '78%',
                        x: '30%',
                        y: '17.5%',
                        max: 450,
