$(function() {
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
                ...
                ../../http/add tooltip                tooltip _1278704999.html{
                    trigger: 'axis'
                },
        ...
        var option = {
                ...
                ../../http/add tooltip                tooltip _1278704999.html{
                    ...
                    axisPointer : {            // Axis indicator axis trigger effective
                        type : 'shadow'        ../../http/the default is a straight line, optionally_1814768187.html 'line' | 'shadow'
                    }
                },

                ../../http/add legend                legend_2117795844.html{
                    data: ['Data1', 'Data2', 'Data3', 'Data4', 'Data5']
                },

                ../../http/add custom colors                color_319619358.html['#689f38', '#38649f', '#389f99', '#ff8f00', '#ee1044'],

                ../../http/horizontal axis                xaxis_1293712746.html[{
                    type: 'value',
                }],

                ../../http/vertical axis                yaxis_858811685.html[{
                    type: 'category',
                    data: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']
                }],

                ../../http/add series                series _1698315013.html[
                    {
                        name:'Data1',
                        type:'bar',
                        stack: 'Total',
       ...
       //***************************
        ...
        var option = {
             ...
             // Setup grid
                ...
                ../../http/enabledragrecalculatecalculabletrue,/Horizontal axis                xAxis_1293712746.html[{
                    type: 'category',
                    data: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']
                }],
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var option = {
             ...
             // Setup grid
                ...
                ../../http/add custom colors                color_319619358.html['#ee1044', '#389f99'],
